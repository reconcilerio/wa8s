...
deploy-ducks: ## Deploy ducks to the K8s cluster specified in ~/.kube/config.
	$(KAPP) deploy -a ducks -n $(KAPP_APP_NAMESPACE) --wait-timeout 5m -c -f https://github.com/reconcilerio/ducks/releases/download/v0.3.0/reconcilerio-ducks-v0.3.0.yaml
