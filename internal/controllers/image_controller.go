		...
		Reconciler: &reconcilers.SuppressTransientErrors[registriesv1alpha1.GenericImage, client.ObjectList]{
			...
			Reconciler: reconcilers.Sequence[registriesv1alpha1.GenericImage]{
				reconcilers.Always[registriesv1alpha1.GenericImage]{
					controllers.ResolveRepository[registriesv1alpha1.GenericImage](registriesv1alpha1.ImageConditionRepositoryReady),
					controllers.ResolveKeychain[registriesv1alpha1.GenericImage](registriesv1alpha1.ImageConditionCopied),
				},
				CopyImage(),
			},
		},
