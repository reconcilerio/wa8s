...
var _ reconcilers.Defaulter = &Repository{}
var _ reconcilers.Defaulter = &ClusterRepository{}

func (r *Repository) Default(ctx context.Context) error {
...
func (r *ClusterRepository) Default(ctx context.Context) error {
	ctx = validation.StashResource(ctx, r)
...
var _ admission.Validator[*ClusterRepository] = &ClusterRepository{}

func (r *Repository) ValidateCreate(ctx context.Context, obj *Repository) (warnings admission.Warnings, err error) {
...
func (r *Repository) ValidateUpdate(ctx context.Context, oldObj, newObj *Repository) (warnings admission.Warnings, err error) {
...
func (r *Repository) ValidateDelete(ctx context.Context, obj *Repository) (warnings admission.Warnings, err error) {
	return
}
...
func (r *ClusterRepository) ValidateCreate(ctx context.Context, obj *ClusterRepository) (warnings admission.Warnings, err error) {
	if err := obj.Default(ctx); err != nil {
		return nil, err
	}
	ctx = validation.StashResource(ctx, obj)
...
func (r *ClusterRepository) ValidateUpdate(ctx context.Context, oldObj, newObj *ClusterRepository) (warnings admission.Warnings, err error) {
	if err := newObj.Default(ctx); err != nil {
		return nil, err
	}
	ctx = validation.StashResource(ctx, newObj)
...
func (r *ClusterRepository) ValidateDelete(ctx context.Context, obj *ClusterRepository) (warnings admission.Warnings, err error) {
	return
}
