...
var _ reconcilers.Defaulter = &CronTrigger{}

func (r *CronTrigger) Default(ctx context.Context) error {
...
var _ admission.Validator[*CronTrigger] = &CronTrigger{}

func (r *CronTrigger) ValidateCreate(ctx context.Context, obj *CronTrigger) (warnings admission.Warnings, err error) {
...
func (r *CronTrigger) ValidateUpdate(ctx context.Context, oldObj, newObj *CronTrigger) (warnings admission.Warnings, err error) {
...
func (r *CronTrigger) ValidateDelete(ctx context.Context, obj *CronTrigger) (warnings admission.Warnings, err error) {
	return
}
