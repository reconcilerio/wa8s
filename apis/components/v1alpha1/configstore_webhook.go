...
//+kubebuilder:webhook:path=/validate-wa8s-reconciler-io-v1alpha1-configstore,mutating=false,failurePolicy=fail,sideEffects=None,groups=wa8s.reconciler.io,resources=configstores,verbs=create;update,versions=v1alpha1,name=v1alpha1.configstores.wa8s.reconciler.io,admissionReviewVersions={v1,v1beta1},serviceName=wa8s-manager-webhook
