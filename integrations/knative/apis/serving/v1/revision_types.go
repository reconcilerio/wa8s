...
// +die
// +die:field:name=ObjectMeta,die=ObjectMetaDie,package=_/meta/v1
// +die:field:name=Spec,die=RevisionSpecDie
...
// +die
// +die:field:name=PodSpec,die=PodSpecDie,package=_/core/v1
...
const (
	...
	RevisionConditionResourcesAvailable = "ResourcesAvailable"

	// RevisionConditionContainerHealthy is set when the revision readiness check completes.
	RevisionConditionContainerHealthy = "ContainerHealthy"
...
// +die
// +die:field:name=ContainerStatuses,die=ContainerStatusDie,listType=map
// +die:field:name=InitContainerStatuses,die=ContainerStatusDie,listType=map
...
func init() {
	schemeBuilder.Register(func(s *runtime.Scheme) error {
		s.AddKnownTypes(GroupVersion, &Revision{}, &RevisionList{})
		return nil
	})
}
