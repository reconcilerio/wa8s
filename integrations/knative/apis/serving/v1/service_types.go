...
// +die
// +die:field:name=ConfigurationSpec,die=ConfigurationSpecDie
// +die:field:name=RouteSpec,die=RouteSpecDie
...
func init() {
	schemeBuilder.Register(func(s *runtime.Scheme) error {
		s.AddKnownTypes(GroupVersion, &Service{}, &ServiceList{})
		return nil
	})
}
